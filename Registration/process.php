...
if(isset($_POST['send']))
{
    ...
    foreach($eco as $item)
    {
       ...
       while($row=mysqli_fetch_assoc($result1))
       {
            ...
            if($price==0)
            {
                ...
                mysqli_select_db($con1, 'persona2023');
    ...
    if($sum!=0)
    {
        ...
        foreach($Cost_Events as $bckitm)
        {
                $myDate2 = date("d-m-y h:i:s");
                $con1 = mysqli_connect('localhost','root','');
                mysqli_select_db($con1, 'persona2023');
                
                $reg2 ="INSERT INTO backuppayment (`Name`,`Email`,`Phone`,`College`,`Event`,`Tid`,`Tstamp`) VALUES ('$Namee','$Emaill','$Phonee','$Collegee','$bckitm','$personaId3','$myDate2')";
                if(mysqli_query($con1 ,$reg2))
                {
