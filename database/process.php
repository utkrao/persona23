...
if(isset($_POST['send']))
{
    ...
    if($sum!=0)
    {
        ...
        foreach($Cost_Events as $bckitm)
        {
                ...
                $reg233 ="INSERT INTO backuppayment (`Name`,`Email`,`Phone`,`College`,`Event`,`Tid`,`Tstamp`) VALUES ('$Namee','$Emaill','$Phonee','$Collegee','$bckitm','$personaId3','$myDate2')";
                if(mysqli_query($con1 ,$reg233))
                {
