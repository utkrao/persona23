    ...
    <div class="panel-details">
      <div class="event-selection">
        <div class="event-dropdown">
          ...
          <input type="name" name="sec_college" placeholder="O4 - PsyCogn" required readonly>
      ...
      <div class="details-table" style="overflow-x:auto;">
        <table id="personatable">
          ...
          if(isset($_POST['showdata'])) 
          {
              ...
              if($pass=="vedic.psycogn")
              {
                $con = mysqli_connect('localhost','exlpuuxq_personanew','exlpuuxq_personanew');
              
                $query1="SELECT p.UniqueId, p.Name, p.Email, p.Phone, p.College,p.Event,c.Event_name,c.cost,c.host_clg,p.Txnid,p.Time FROM participants p INNER JOIN costs c ON p.Event COLLATE utf8mb4_unicode_ci = c.event WHERE p.Event = 'O4'";
